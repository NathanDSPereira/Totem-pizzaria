...
export default function IdentificacaoModal({fechar, confirmarIdentificacaoCliente}: {fechar: () => void, confirmarIdentificacaoCliente: (nome: string, telefone: string) => void}) {
    ...
    return (
        <section className="fixed inset-0 bg-black/80 backdrop-blur-sm z-100 flex justify-center items-center">
            <div className="max-w-[100vw] w-[90vw] max-h-[90vh] h-[90vh] md:h-screen bg-zinc-950 border border-zinc-900 rounded-2xl p-5 animate-in zoom-in duration-300">
                    ...
                    <div className="w-full h-full flex flex-col">
                        ...
                        <div className="flex flex-col items-center h-full w-full">
                            ...
                            <div className="flex flex-col h-full w-full justify-around items-center">
                                <div className="flex gap-10 w-3/4 flex-col justify-center items-center">
                                    <input 
                                        type="text" 
                                        value={nome}
