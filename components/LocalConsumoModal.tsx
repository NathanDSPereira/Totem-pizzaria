export default function LocalConsumoModal({fechar, selecionarLocalConsumo}: {fechar: () => void, selecionarLocalConsumo: (local: 'local' | 'viagem') => void}) {
    return (
        <section className="fixed inset-0 bg-black/80 backdrop-blur-sm z-100 flex justify-center items-center">
            <div className="max-w-[90vw] w-[80vw] max-h-[90vh] h-[80vh] bg-zinc-950 border border-zinc-900 rounded-2xl animate-in zoom-in duration-300">
                <div className="w-full h-full">    
                    <div className="w-full h-full flex flex-col justify-center">
                        ...
                        <div className="w-full h-full flex flex-col justify-around gap-10">
                            ...
                            <div className="mt-8 flex gap-10 flex-wrap px-5">
                                <button 
                                    onClick={() => selecionarLocalConsumo('local')}
                                    className="flex-1 bg-amber-600 transition-all  text-black font-bold h-56 rounded-2xl shadow-lg active:scale-95">
                                ...
                                <button 
                                    ...
                                    className="flex-1 bg-zinc-800 transition-all  text-zinc-500 font-bold h-56 rounded-2xl shadow-lg active:scale-95">
                                    <div className="flex flex-col gap-10 justify-center items-center">
