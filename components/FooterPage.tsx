      ...
      <footer className="fixed bottom-0 bg-zinc-900/90 backdrop-blur-md w-full border-t border-zinc-800 h-36 flex justify-between p-10 items-center">
        ...
        <div className="flex items-center gap-8">
          <div>
            ...
            <p className="text-4xl font-black sm:text-2xl text-orange-500">
          ...
          <button
            onClick={() => aoFinalizar()} 
            className="bg-orange-500 active:bg-orange-600 text-black font-black text-2xl px-6 py-6 rounded-3xl flex items-center gap-4 transition-all active:scale-95 shadow-[0_0_30px_rgba(249,115,22,0.2)]">
            FINALIZAR
          </button>
        </div>
      </footer>
