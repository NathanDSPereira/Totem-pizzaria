...
export default function CustomizacaoPizzaModal({produto, fecharModal, todosOsIngredientes}: {produto: Pizza, fecharModal: () => void, todosOsIngredientes: Ingredientes[]}) {
    ...
    return (
        <div className="fixed inset-0 bg-black/80 z-150 flex flex-col items-center justify-center md:flex-row w-full">
            <div className="w-full max-w-[95vw] h-full max-h-[90vh] bg-zinc-950 border border-zinc-800 rounded-[40px] shadow-2xl overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 bg-zinc-950 p-12 flex flex-col">
