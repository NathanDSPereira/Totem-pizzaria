...
export default function SelecionarQuantidadeExclusaoModal({confirmar, produtoARetirarCarrinho, setProdutoARetirarCarrinho}: {confirmar: (quantidade: number) => void, produtoARetirarCarrinho: ItemCarrinho, setProdutoARetirarCarrinho: (state: null) => void}) {
    ...
    return (
        <section className="fixed insert-0 bg-black/70 backdrop-blur-sm z-300 w-full h-full flex items-center justify-center">
            <div className="bg-zinc-950 border border-zinc-800 rounded-4xl shadow-2xl max-w-[90vw] w-[80vw] max-h-[90vh] h-[80vh] flex flex-col items-center">
                <div className="w-full h-full flex flex-col">
                    ...
                    <div className="flex items-center max-h-full flex-col justify-around h-full">
                        <div className="text-center">
                            <h3 className="text-slate-200 text-4xl font-bold letter-spacing tracking-wide">
                        ...
                        <div className="flex justify-around gap-10 items-center">
                            <button 
                                ...
                                className="w-36 h-36 md:w-20 md:h-20 rounded-2xl bg-zinc-900 border border-zinc-800 text-6xl text-zinc-300 active:scale-90 transition-all">
                                -
                            </button>
                            ...
                            <button 
                                ...
                                className="w-36 h-36 md:w-20 md:h-20 rounded-2xl bg-amber-600 text-6xl text-zinc-950 active:scale-90 transition-all">
                                +
                            </button>
                        </div>
                        ...
                        <div className="mb-10">
                            <button
                                ...
                                className="w-80 h-32 md:h-20 font-bold rounded-2xl bg-amber-600 text-4xl text-zinc-950 active:scale-90 transition-all">
                                Confirmar
                            </button>
                        </div>
                    </div>
